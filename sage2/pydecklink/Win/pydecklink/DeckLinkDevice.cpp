...
DeckLinkDevice::DeckLinkDevice(DeckLinkManager* manager, IDeckLink* device)
: m_manager(manager), m_deckLink(device), m_deckLinkInput(NULL), m_supportsFormatDetection(false),
...
HRESULT 	DeckLinkDevice::VideoInputFrameArrived (/* in */ IDeckLinkVideoInputFrame* videoFrame, /* in */ IDeckLinkAudioInputPacket* audioPacket)
{
	...
	m_manager->FrameArrived(videoFrame, audioPacket);
...
DeckLinkDeviceDiscovery::DeckLinkDeviceDiscovery(DeckLinkManager* manager)
: m_manager(manager), m_deckLinkDiscovery(NULL), m_refCount(1)
{
